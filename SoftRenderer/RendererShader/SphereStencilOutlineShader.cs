...
namespace RendererShader
{
    ...
    public class SphereStencilOutlineShader : ShaderBase
    {
        ...
        private class _SubShader : SubShaderExt<SphereStencilOutlineShader>
        {
            public _SubShader(SphereStencilOutlineShader shader) : base(shader)
            {
        ...
        private class _PassExt : PassExt<_SubShader>
        {
            ...
            private SphereStencilOutlineShader shader;
        ...
        public SphereStencilOutlineShader(BasicShaderData data) : base(data)
        {
