...
namespace SoftRendererShader
{
    ...
    [VS]
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class SphereVertexShader : ShaderBase
    {
        ...
        public SphereVertexShader(BasicShaderData data) : base(data)
        {
        }
    ...
    [FS]
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class SphereFragmentShader : FSBase
    {
        [Name] public static readonly string Name = "SphereFragmentShader";
        [NameHash] public static readonly int NameHash = NameUtil.HashID(Name);
        ...
        public SphereFragmentShader(BasicShaderData data) : base(data)
        {
            //sampler.wrapMode = SampleWrapMode.Clamp;
            //sampler.wrapMode = SampleWrapMode.Repeat;
            //sampler.wrapMode = SampleWrapMode.Mirror;
